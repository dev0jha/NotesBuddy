...
import { getUserFlashcardSubjectsAction } from "@/app/(main)/(user)/flashcards/actions";
...
export default function FilterFlashcardDropdown({
  userProfile,
  isOnboarded = false,
  isAuthenticated = false,
}: FilterFlashcardDropdownProps) {
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      ...
      try {
        const subjectData = await getUserFlashcardSubjectsAction({
