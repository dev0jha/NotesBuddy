  ...
  return (
    <div className="flex items-center justify-center gap-2">
      ...
      <Button
        ...
        className="neuro-button font-satoshi rounded-md font-bold text-black/70 disabled:opacity-50 dark:text-white/70"
      >
            ...
            <Button
              ...
              className={`font-satoshi h-10 w-10 rounded-md font-bold ${
                isActive
                  ...
                  : "neuro-button text-black/70 dark:text-white/70"
              }`}
            >
              {pageNumber}
            </Button>
